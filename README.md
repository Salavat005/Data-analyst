...
|-----------|-------------------|------------------------------------------------------------------|-----------------------------------|
|1              |[Визуальный анализ рейтингов шоу Netflix](Первичный анализ данных/)|Анализ датасета 1000 Netflix Shows (по состоянию на 11.06.2017) и сделать выводы.|`Python` `Pandas` `scipy` `numpy` `plotly`|
