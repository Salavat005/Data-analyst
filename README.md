...
|3              |[Проект по А/B-тестированию]([real_estate_market/](АБ тест))|Тестирование изменений, связанных с внедрением улучшенной рекомендательной системы|`Python` `Pandas` `Matplotlib` `Seaborn` `продуктовые метрики` `A/B-тестирование` `Проверка статистических гипотез`|
