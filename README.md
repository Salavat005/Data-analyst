...
|3              |[Проект по А/B-тестированию]([real_estate_market/](https://github.com/Salavat005/Data-analyst/tree/e777bdb4ed932671dc6b26b0cbc3a75ef665704a/%D0%90%D0%91%20%D1%82%D0%B5%D1%81%D1%82))|Тестирование изменений, связанных с внедрением улучшенной рекомендательной системы|`Python` `Pandas` `Matplotlib` `Seaborn` `продуктовые метрики` `A/B-тестирование` `Проверка статистических гипотез`|
